...
function vkGetPhysicalDeviceXcbPresentationSupportKHR(physicalDevice, queueFamilyIndex, connection, visual_id)
    ccall((:vkGetPhysicalDeviceXcbPresentationSupportKHR, libvulkan), VkBool32, (VkPhysicalDevice, UInt32, Ptr{Cint}, Cint), physicalDevice, queueFamilyIndex, connection, visual_id)
end
...
function vkGetPhysicalDeviceXlibPresentationSupportKHR(physicalDevice, queueFamilyIndex, dpy, visualID)
    ccall((:vkGetPhysicalDeviceXlibPresentationSupportKHR, libvulkan), VkBool32, (VkPhysicalDevice, UInt32, Ptr{Cint}, Cint), physicalDevice, queueFamilyIndex, dpy, visualID)
end
...
function vkAcquireXlibDisplayEXT(physicalDevice, dpy, display)
    ccall((:vkAcquireXlibDisplayEXT, libvulkan), VkResult, (VkPhysicalDevice, Ptr{Cint}, VkDisplayKHR), physicalDevice, dpy, display)
end

function vkGetRandROutputDisplayEXT(physicalDevice, dpy, rrOutput, pDisplay)
    ccall((:vkGetRandROutputDisplayEXT, libvulkan), VkResult, (VkPhysicalDevice, Ptr{Cint}, Cint, Ptr{VkDisplayKHR}), physicalDevice, dpy, rrOutput, pDisplay)
end
...
const VK_PLATFORM_H_ = nothing

const VKAPI_ATTR = nothing

const VKAPI_CALL = nothing

const VKAPI_PTR = nothing
...
# Skipping MacroDefinition: VK_ATTACHMENT_UNUSED ( ~ 0U )

const VK_FALSE = 0

const VK_LOD_CLAMP_NONE = Float32(1000.0)

# Skipping MacroDefinition: VK_QUEUE_FAMILY_IGNORED ( ~ 0U )

# Skipping MacroDefinition: VK_REMAINING_ARRAY_LAYERS ( ~ 0U )

# Skipping MacroDefinition: VK_REMAINING_MIP_LEVELS ( ~ 0U )

# Skipping MacroDefinition: VK_SUBPASS_EXTERNAL ( ~ 0U )

const VK_TRUE = 1

# Skipping MacroDefinition: VK_WHOLE_SIZE ( ~ 0ULL )
...
# Skipping MacroDefinition: VK_QUEUE_FAMILY_EXTERNAL ( ~ 0U - 1 )
...
# Skipping MacroDefinition: VK_QUEUE_FAMILY_FOREIGN_EXT ( ~ 0U - 2 )
...
# Skipping MacroDefinition: VK_SHADER_UNUSED_KHR ( ~ 0U )

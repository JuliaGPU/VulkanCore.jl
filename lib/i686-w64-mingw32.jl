...
# typedef VkResult ( VKAPI_PTR * PFN_vkBindAccelerationStructureMemoryKHR
...
const VK_QUEUE_FAMILY_EXTERNAL = ~(Cuint(0)) - 1
...
const VK_QUEUE_FAMILY_FOREIGN_EXT = ~(Cuint(0)) - 2

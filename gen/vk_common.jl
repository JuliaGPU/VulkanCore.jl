...
const VK_EXT_FILTER_CUBIC_SPEC_VERSION = 2
...
const VK_INTEL_SHADER_INTEGER_FUNCTIONS2_SPEC_VERSION = 1
const VK_INTEL_SHADER_INTEGER_FUNCTIONS2_EXTENSION_NAME = "VK_INTEL_shader_integer_functions2"
const VK_INTEL_performance_query = 1
const VK_INTEL_PERFORMANCE_QUERY_SPEC_VERSION = 1
...
const VK_EXT_HEADLESS_SURFACE_SPEC_VERSION = 0
...
@cenum VkDriverIdKHR::UInt32 begin
...
@cenum VkResolveModeFlagBitsKHR::UInt32 begin
...
const VkObjectTableNVX_T = Cvoid
const VkObjectTableNVX = Ptr{VkObjectTableNVX_T}
const VkIndirectCommandsLayoutNVX_T = Cvoid
const VkIndirectCommandsLayoutNVX = Ptr{VkIndirectCommandsLayoutNVX_T}

@cenum VkIndirectCommandsTokenTypeNVX::UInt32 begin
...
@cenum VkObjectEntryTypeNVX::UInt32 begin
...
@cenum VkIndirectCommandsLayoutUsageFlagBitsNVX::UInt32 begin
...
@cenum VkObjectEntryUsageFlagBitsNVX::UInt32 begin
...
@cenum VkSamplerReductionModeEXT::UInt32 begin
...
@cenum VkDescriptorBindingFlagBitsEXT::UInt32 begin
...
@cenum VkRayTracingShaderGroupTypeNV::UInt32 begin
...
@cenum VkGeometryTypeNV::UInt32 begin
...
@cenum VkAccelerationStructureTypeNV::UInt32 begin
...
@cenum VkCopyAccelerationStructureModeNV::UInt32 begin
...
@cenum VkGeometryFlagBitsNV::UInt32 begin
...
@cenum VkGeometryInstanceFlagBitsNV::UInt32 begin
...
@cenum VkBuildAccelerationStructureFlagBitsNV::UInt32 begin
